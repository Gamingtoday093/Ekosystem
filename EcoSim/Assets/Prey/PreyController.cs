...
public class PreyController : MonoBehaviour
{
    ...
    private void AssignSex()
    {
        ...
        {
            this.gameObject.tag = "Maleprey";
            rndNumber = Mathf.Clamp(rndNumber, 1, 10);
            float varies = UnityEngine.Random.Range(0.9f, 1.1f);
            speed = speed * varies;
            varies = UnityEngine.Random.Range(0.9f, 1.1f);
            detectionradius = detectionradius * varies;
        ...
        {
            this.gameObject.tag = "Femaleprey";
            rndNumber = Mathf.Clamp(rndNumber, 1, 10);
    ...
    private void Search()
    {
        ...
        {
            if (hitCollider.tag == "Maleprey" && primary != "Water" && primary != "Food")
            {
                Averagedesirability += hitCollider.GetComponent<PreyController>().desirability;
                TotMale++;
                Averagedesirability = Mathf.Ceil(Averagedesirability / TotMale);
            }
            if (hitCollider.tag == primary)
            {
                if (primary == "Femaleprey")
                {
                    if (hitCollider.GetComponent<PreyController>().pregnant == false && hitCollider.GetComponent<PreyController>().age == 10)
                    {
                ...
                else if (primary == "Maleprey" && hitCollider.GetComponent<PreyController>().desirability >= Averagedesirability && hitCollider.GetComponent<PreyController>().age == 10)
                {
                    legalhitColliders.Add(hitCollider);
                }
                else
        ...
        else if (legalhitColliders.Count != 0)
        {
            ...
            if (Mathf.Floor(MyX - FoodX) == 0 && Mathf.Floor(MyZ - FoodZ) == 0)
            {
                ...
                if (primary == "Maleprey" && this.gameObject.tag == "Femaleprey" && pregnant == false)
                {
                    localdesirability = legalhitColliders[0].GetComponent<PreyController>().desirability;
    ...
    private void ispregnant()
    {
        ...
        {
            GameObject Child = GameObject.Find("Map").GetComponent<Landgenerator>().prey;
            ...
            for (int i = 0; i < Children; i++)
            {
                ...
                var Childprop = Child.GetComponent<PreyController>();
                ...
                ColorHandler();
                GameObject.Find("UI").GetComponent<Statistics>().children += 1;
            }
        }
    }
